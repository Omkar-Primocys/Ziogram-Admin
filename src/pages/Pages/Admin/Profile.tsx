                    ...
                    <div className="panel">
                        ...
                        <div className="mb-5">
                            <div className="flex flex-col justify-center items-center">
                                <img src={admin.profilePic} alt="img" className="w-24 h-24 rounded-full object-cover  mb-5" />
                                <p className="font-semibold text-primary text-xl">{admin.name} </p>
                            </div>
                            <ul className="mt-5 flex flex-col max-w-[160px] m-auto space-y-4 font-semibold text-white-dark">
                                <li className="flex items-center gap-2">
                                    <IconCoffee className="shrink-0" />
                                    Head Admin at Ziogram
                                </li>
                                <li className="flex items-center gap-2">
                                ...
                                <li>
                                    <button className="flex items-center gap-2">
                                        ...
                                        <span className="text-primary truncate">{admin.adminEmail}</span>
                                    </button>
                                </li>
                                <li className="flex items-center gap-2">
                                    <IconPhone />
